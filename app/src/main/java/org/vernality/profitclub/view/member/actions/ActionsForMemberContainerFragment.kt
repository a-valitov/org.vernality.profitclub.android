...
class ActionsForMemberContainerFragment : Fragment() {
    ...
    private lateinit var homeViewModel: ActionsForMemberContainerFragmentViewModel
    ...
    override fun onCreateView(
        ...
        homeViewModel =
            ViewModelProviders.of(this).get(ActionsForMemberContainerFragmentViewModel::class.java)
